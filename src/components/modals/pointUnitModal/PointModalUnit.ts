import { PointUnitsModel, PointUnitType } from '@discord-point-bot/models';
...
export const PointModalUnit: DiscordType.IModalSubmit = {
  ...
  execute: async ({ interaction }) => {
    ...
    const secondActionRow = interaction.fields.getTextInputValue(
      'point_unit/add_unit/scoring_desc',
    );
